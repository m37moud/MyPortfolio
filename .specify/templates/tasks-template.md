...
unless the feature specification requests them, but constitution-driven QA tasks
for responsive behavior, accessibility, content accuracy, and conversion links
MUST be included when relevant.
...
- [ ] T010 Capture shared content sources and QA criteria for proof-backed copy,
  responsive behavior, accessibility, and conversion actions
...
- [ ] T018 [US1] Verify proof-backed content, accessibility, and conversion
  paths for user story 1
...
- [ ] T025 [US2] Verify proof-backed content, accessibility, and conversion
  paths for user story 2
...
- [ ] T031 [US3] Verify proof-backed content, accessibility, and conversion
  paths for user story 3
...
- [ ] TXXX [P] Validate content against approved source documents
- [ ] TXXX [P] Run mobile and desktop responsive QA
- [ ] TXXX [P] Verify resume/contact/social conversion links
